	...
	*/
	...
	switch(userInput){	
		...
		case 5: {
			...
			// cout << "\nNote: I have incorrectly assigned the exit";
			// cout << "\ncondition and it seems to be exiting before";
			// cout << "\nall of the nodes are searched. I tried";
			// cout << "\nimplementing from the text but with no luck!";
			// cout << "\nI did get the weights adding correctly and was";
			// cout << "\nable to get the path the nodes are taking to";
			// cout << "\nprint correctly for all but district 2." << endl;
			break;
		}
