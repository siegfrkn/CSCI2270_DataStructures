// THIS VERSION HAS PARSING TO COMPARE INPUT FILE TO IGNORE WORDS AND INCREMENTING COUNTS FOR DUPLICATES
...
int main(int argc, char **argv){
	...
	uniqueResults = readInFileArray(fileMainString, &arraySize, arrayWords, arrayIgnoreWords);
