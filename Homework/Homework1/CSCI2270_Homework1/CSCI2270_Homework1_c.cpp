...
while (userExit == 0){
	...
	switch(userInput){
		case 1: {cout << "ENTER THE NAME OF THE ITEM YOU ARE LOOKING FOR\n" << endl;
				string userFindItem;
				cin >> userFindItem;
				cout << " " << endl;
				userPrice = 0;
				...
				if (findItemIndex != -1){
					cout << "\nITEM FOUND\n" << endl;
					cout << arrayOfGarageItems[findItemIndex].type << " " << arrayOfGarageItems[findItemIndex].forSale << " " << arrayOfGarageItems[findItemIndex].price << "\n" << endl;
				}
				else{
					cout << "\nITEM NOT FOUND\n" << endl;
					//Sleep(1000);
